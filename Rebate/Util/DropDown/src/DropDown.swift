...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
	...
	public func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        //Added by mobilestar - for sending message to shareview
        NSNotificationCenter.defaultCenter().postNotificationName(notificationDropDownCellChanged, object: nil)
